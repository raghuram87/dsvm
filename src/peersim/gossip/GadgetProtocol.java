...
public class GadgetProtocol implements CDProtocol {
	...
	public void nextCycle(Node node, int pid) {
		...
		// Perform optimization only once across the entire network
		if(!optimizationDone) {
			generateOptimalB();
			optimizationDone = true;
			writeIntoFile(String.valueOf(System.currentTimeMillis()));
		}
	...
	/**
	 * Select random neighbor based on transition probabilities
	 * @param node
	 * @return
	 */
